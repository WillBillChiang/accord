...
Verifies session creation, party onboarding, expiry, termination,
provable deletion, and negotiation logging inside the Confidential VM.
Copied from enclave/tests with imports updated for engine.session
and engine.protocol.schemas.
"""
import pytest
import time
import sys
